...
test('в ф-ции initFun() замокаем setStatus(), get_products_in_basket(), setItems() и протестированную ранее initValues(), чтобы убедиться, что initFun() верно работает', () => {
